...
- [**conventions/test-architecture.md**](conventions/test-architecture.md) — contrato de factories, request builders y helpers de cache para reducir duplicación en tests sin ocultar intención.
...
| Voy a crear o refactorizar tests repetidos    | [conventions/test-architecture.md](conventions/test-architecture.md) |
