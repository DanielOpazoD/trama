...
- `MomentoShareModal.tsx` + `MomentosShareInvitations.tsx` — invitar por correo al espacio completo de Momentos y aceptar/rechazar invitaciones compartidas
