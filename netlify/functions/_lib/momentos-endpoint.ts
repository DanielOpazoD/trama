 ...
 *
 * El acceso a datos vive en `./momentos/data.ts`; el handler por defecto es un
 * router que resuelve auth y despacha a un handler por operación (abajo).
 */

type Sql = ReturnType<typeof getSql>
type AuthedUser = Awaited<ReturnType<typeof getAuthedUser>>

// ---------------- GET one ----------------
async function handleGetMomento(
  sql: Sql,
  id: string,
  userId: string,
  requestId: string,
...
// ---------------- GET list ----------------
async function handleListMomentos(
  req: Request,
  sql: Sql,
  userId: string,
  requestId: string,
...
// ---------------- POST create ----------------
async function handleCreateMomento(
  req: Request,
  sql: Sql,
...
// ---------------- PATCH update ----------------
async function handleUpdateMomento(
  req: Request,
  sql: Sql,
  id: string,
  authedUser: AuthedUser,
...
// ---------------- DELETE soft ----------------
async function handleDeleteMomento(
  req: Request,
  sql: Sql,
  id: string,
  authedUser: AuthedUser,
