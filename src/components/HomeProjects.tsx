 ...
 * (no cerrados). Refuerza la persistencia de Flujo — el usuario vuelve a su
 * trabajo sin reconstruirlo. Se oculta del todo si no hay proyectos abiertos.
 * El enlace es un deep-link a Flujo con ?project=<id> (lo abre directo).
 */
