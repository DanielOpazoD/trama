 ...
 * (no cerrados). Refuerza la persistencia del trabajo — el usuario vuelve a sus
 * materiales sin reconstruirlos. Se oculta del todo si no hay proyectos
 * abiertos. El enlace entra por el feed de Notas.
 */
