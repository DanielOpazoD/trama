...
export function ShortcutsModal({
  ...
  // El portal, el backdrop, el foco, Escape y el scroll-lock los pone ModalShell.
  ...
  return (
    ...
    >
      ...
      <header className="px-6 pad-block-5 border-b border-ink-100/60 flex items-baseline justify-between">
      ...
      <footer className="px-6 py-3 border-t border-ink-100/60 text-micro text-ink-300 tabular-nums">
        presiona{' '}
