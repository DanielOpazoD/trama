...
export function GraphTypeLegend({
  ...
  return (
    // Sin posicionamiento propio: la coloca la columna izquierda del raíl
    // inferior de `GraphChrome`. Repone `pointer-events-auto` porque ese raíl
    // es transparente al puntero para no robarle el pan al lienzo.
