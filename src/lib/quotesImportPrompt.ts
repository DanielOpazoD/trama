...
OBJETIVO
Te voy a dar uno o más autores (al final de este mensaje). Para cada autor, incluí entre 8 y 15 de sus citas más conocidas y verificables. No inventes citas ni atribuciones: si no estás seguro de que una frase sea realmente de ese autor, omitila.
...
- Respondé ÚNICAMENTE con el JSON válido. Sin texto antes ni después, sin explicaciones y sin envolverlo en bloques de código con tildes.

EJEMPLO DE ESTRUCTURA (un autor, dos citas — reemplazá por contenido real):

{
  ...
  "quotes": [
    { "id": "autor-ejemplo-1", "entityId": "autor-ejemplo", "text": "La cita textual completa, tal como la escribió el autor.", "source": "Título de la obra", "context": null },
    { "id": "autor-ejemplo-2", "entityId": "autor-ejemplo", "text": "Otra cita del mismo autor.", "source": null, "context": "verso final del poema" }
  ]
}

AUTORES QUE QUIERO (reemplazá esta línea por los nombres, separados por comas):
- `
