...
| Cambios arquitectura    | `check:architecture`, `check:dependency-cruiser`, `check:knip`, `check:dead-code`, `check:frontend-boundaries`, `check:storage-boundaries`                                                              | Fronteras importables, ciclos, dead code y dependencias declaradas.                         |
...
| `ci`        | Registry, dead code, grafo de imports y ratchets de quality gates.      | `check-script-registry`, `check:knip`, `check:dead-code`, `check:architecture`, `check:dependency-cruiser`, `check-structure-ratchets`, `verify-pr-stack`.            |
