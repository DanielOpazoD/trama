...
| Cambios auth/multiuser  | `check:legacy-fallback`, `check:auth-rls-contracts`, `check:legacy-identity-contracts`, `check:user-id-writes`, `legacy-data-reassignment:dry-run`, `check:operational-observability` | Complementar con smoke si toca aislamiento real.                |
