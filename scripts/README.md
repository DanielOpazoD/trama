...
| Cambios DB/migraciones  | `check:migration-duplicates`, `check:hard-delete-allowlist`, `check:storage-boundaries`, `check:legacy-identity-schema`, `scripts/apply-migrations.sh`, `check:cte-regression`        | No editar migraciones aplicadas.                                                            |
...
| `database`  | Migraciones, soft-delete, CTEs atomicos, storage y Postgres real.       | `apply-migrations`, `check:migration-duplicates`, `check:hard-delete-allowlist`, `check:storage-boundaries`, `check:legacy-identity-schema`. |
