...
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| Antes de commit         | `npm run format:check`, test focalizado, `npm run check:script-registry`, `npm run check:knip`, `npm run check:architecture`                                                                            | Feedback rapido antes de push.                                                              |
...
| Cambios arquitectura    | `check:architecture`, `check:knip`, `check:frontend-boundaries`, `check:storage-boundaries`                                                                                                             | Fronteras importables, ciclos, dead code y dependencias declaradas.                         |
...
| `ci`        | Registry, dead code, grafo de imports y ratchets de quality gates.      | `check-script-registry`, `check:knip`, `check:architecture`, `check-structure-ratchets`, `verify-pr-stack`.                                                           |
