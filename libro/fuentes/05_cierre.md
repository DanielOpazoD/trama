...
- **Incertidumbre**: nombrar lo que puede cambiar el modelo o la conducta.
...
- Duda irreductible o no relevante para la decisión inmediata.
...
| **No demostrado** | Hipótesis razonable sin evidencia suficiente para afirmarla | "Estrangulación no demostrada en imagen ni cirugía" | Confundirlo con "descartado" (ausencia de prueba ≠ prueba de ausencia) |
...
- Pase de turno: agregar una línea obligatoria por paciente inestable o incierto: "qué vigilar, qué reabriría el caso, quién verifica el pendiente".
...
- Reformatear una reunión de morbimortalidad al formato de la viñeta 8: reconstrucción por capas, con la información disponible en cada momento, sin nombres de sesgos como conclusión y con una barrera concreta como producto de cada sesión.
